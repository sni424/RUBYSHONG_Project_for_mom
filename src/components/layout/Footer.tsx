...
const Footer = () => {
  return (
    <footer id="contact" className="bg-surface">
      <div className="mx-auto w-full max-w-7xl px-5 py-14 md:px-10 md:py-20">
        <div className="border-line md:border-r md:pr-10">
          ...
          <div id="reservation" className="border-line md:border-r md:px-10">
            ...
            <button
              type="button"
              className="mt-6 w-full border border-accent px-8 py-4 text-sm tracking-[0.08em] text-accent transition hover:bg-accent hover:text-white md:w-[180px]"
            >
              예약하기
            </button>
          </div>
          ...
          <div className="relative md:pl-10">
            ...
            <div className="mt-6 flex flex-col gap-3 sm:flex-row">
              <button
                type="button"
                className="flex h-14 items-center justify-center gap-3 border border-line px-8 text-sm text-text-secondary transition hover:border-accent hover:text-accent"
              >
                <FaComment size={15} />
                카카오톡 상담
              </button>
            ...
            <div className="pointer-events-none absolute bottom-[-30px] right-0 hidden text-[120px] leading-none text-accent/15 lg:block">
              ✧
            </div>
          </div>
        </div>
